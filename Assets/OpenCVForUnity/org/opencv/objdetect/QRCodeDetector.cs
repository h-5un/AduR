...
namespace OpenCVForUnity.ObjdetectModule
{
    ...
    public class QRCodeDetector : DisposableOpenCVObject
    {
        ...
        public string decodeCurved(Mat img, Mat points, Mat straight_qrcode)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(objdetect_QRCodeDetector_decodeCurved_10(nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj));
        ...
        public string decodeCurved(Mat img, Mat points)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(objdetect_QRCodeDetector_decodeCurved_11(nativeObj, img.nativeObj, points.nativeObj));
        ...
        public string detectAndDecodeCurved(Mat img, Mat points, Mat straight_qrcode)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(objdetect_QRCodeDetector_detectAndDecodeCurved_10(nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj));
        ...
        public string detectAndDecodeCurved(Mat img, Mat points)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(objdetect_QRCodeDetector_detectAndDecodeCurved_11(nativeObj, img.nativeObj, points.nativeObj));
        ...
        public string detectAndDecodeCurved(Mat img)
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(objdetect_QRCodeDetector_detectAndDecodeCurved_12(nativeObj, img.nativeObj));
