...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class SimpleBlobDetector : Feature2D
    {
        ...
        public static SimpleBlobDetector create(SimpleBlobDetector_Params parameters)
        {
            ...
            return SimpleBlobDetector.__fromPtr__(features2d_SimpleBlobDetector_create_10(parameters.nativeObj));
        ...
        public static SimpleBlobDetector create()
        {
            ...
            return SimpleBlobDetector.__fromPtr__(features2d_SimpleBlobDetector_create_11());
