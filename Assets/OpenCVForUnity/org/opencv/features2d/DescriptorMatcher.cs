...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class DescriptorMatcher : Algorithm
    {
        ...
        public static DescriptorMatcher create(string descriptorMatcherType)
        {
            ...
            return DescriptorMatcher.__fromPtr__(features2d_DescriptorMatcher_create_10(descriptorMatcherType));
        ...
        public static DescriptorMatcher create(int matcherType)
        {
            ...
            return DescriptorMatcher.__fromPtr__(features2d_DescriptorMatcher_create_11(matcherType));
