...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class AffineFeature : Feature2D
    {
        ...
        public static AffineFeature create(Feature2D backend, int maxTilt, int minTilt, float tiltStep)
        {
            ...
            return AffineFeature.__fromPtr__(features2d_AffineFeature_create_11(backend.getNativeObjAddr(), maxTilt, minTilt, tiltStep));
        ...
        public static AffineFeature create(Feature2D backend, int maxTilt)
        {
            ...
            return AffineFeature.__fromPtr__(features2d_AffineFeature_create_13(backend.getNativeObjAddr(), maxTilt));
        ...
        public override string getDefaultName()
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(features2d_AffineFeature_getDefaultName_10(nativeObj));
