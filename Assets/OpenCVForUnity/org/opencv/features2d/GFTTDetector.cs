...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class GFTTDetector : Feature2D
    {
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize, bool useHarrisDetector, double k)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_10(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector, k));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize, bool useHarrisDetector)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_11(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_12(maxCorners, qualityLevel, minDistance, blockSize));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_13(maxCorners, qualityLevel, minDistance));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_14(maxCorners, qualityLevel));
        ...
        public static GFTTDetector create(int maxCorners)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_15(maxCorners));
        ...
        public static GFTTDetector create()
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_16());
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize, int gradiantSize, bool useHarrisDetector, double k)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_17(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize, useHarrisDetector, k));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize, int gradiantSize, bool useHarrisDetector)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_18(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize, useHarrisDetector));
        ...
        public static GFTTDetector create(int maxCorners, double qualityLevel, double minDistance, int blockSize, int gradiantSize)
        {
            ...
            return GFTTDetector.__fromPtr__(features2d_GFTTDetector_create_19(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize));
