...
namespace OpenCVForUnity.Features2dModule
{
    ...
    public class BRISK : Feature2D
    {
        ...
        public static BRISK create(int thresh, int octaves, float patternScale)
        {
            ...
            return BRISK.__fromPtr__(features2d_BRISK_create_10(thresh, octaves, patternScale));
        ...
        public static BRISK create(int thresh, int octaves)
        {
            ...
            return BRISK.__fromPtr__(features2d_BRISK_create_11(thresh, octaves));
        ...
        public static BRISK create(int thresh)
        {
            ...
            return BRISK.__fromPtr__(features2d_BRISK_create_12(thresh));
        ...
        public static BRISK create()
        {
            ...
            return BRISK.__fromPtr__(features2d_BRISK_create_13());
        ...
        public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax, float dMin, MatOfInt indexChange)
        {
            ...
            return BRISK.__fromPtr__(features2d_BRISK_create_14(radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin, indexChange_mat.nativeObj));
        ...
        public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax, float dMin)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_15(radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin));
        ...
        public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_16(radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax));
        ...
        public static BRISK create(MatOfFloat radiusList, MatOfInt numberList)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_17(radiusList_mat.nativeObj, numberList_mat.nativeObj));
        ...
        public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax, float dMin, MatOfInt indexChange)
        {
            ...
            Mat numberList_mat = numberList;
            Mat indexChange_mat = indexChange;
            return BRISK.__fromPtr__(features2d_BRISK_create_18(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin, indexChange_mat.nativeObj));
        ...
        public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax, float dMin)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_19(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax, dMin));
        ...
        public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList, float dMax)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_110(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj, dMax));
        ...
        public static BRISK create(int thresh, int octaves, MatOfFloat radiusList, MatOfInt numberList)
        {
            ...
            Mat radiusList_mat = radiusList;
            Mat numberList_mat = numberList;
            return BRISK.__fromPtr__(features2d_BRISK_create_111(thresh, octaves, radiusList_mat.nativeObj, numberList_mat.nativeObj));
