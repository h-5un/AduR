...
namespace OpenCVForUnity.VideoioModule
{
    ...
    public class VideoCapture : DisposableOpenCVObject
    {
        ...
        public VideoCapture(string filename, int apiPreference)
        {
            ...
            nativeObj = videoio_VideoCapture_VideoCapture_11(filename, apiPreference);
        ...
        public VideoCapture(string filename)
        {
            ...
            nativeObj = videoio_VideoCapture_VideoCapture_12(filename);
        ...
        public VideoCapture(string filename, int apiPreference, MatOfInt _params)
        {
            ...
            nativeObj = videoio_VideoCapture_VideoCapture_13(filename, apiPreference, _params_mat.nativeObj);
        ...
        public VideoCapture(int index, int apiPreference)
        {
            ...
            nativeObj = videoio_VideoCapture_VideoCapture_14(index, apiPreference);
        ...
        public VideoCapture(int index)
        {
            ...
            nativeObj = videoio_VideoCapture_VideoCapture_15(index);
        ...
        public VideoCapture(int index, int apiPreference, MatOfInt _params)
        {
            if (_params != null) _params.ThrowIfDisposed();
            Mat _params_mat = _params;
            nativeObj = videoio_VideoCapture_VideoCapture_16(index, apiPreference, _params_mat.nativeObj);
