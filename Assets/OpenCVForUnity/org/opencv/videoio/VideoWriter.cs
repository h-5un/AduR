...
namespace OpenCVForUnity.VideoioModule
{
    ...
    public class VideoWriter : DisposableOpenCVObject
    {
        ...
        public VideoWriter()
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_10();
        ...
        public VideoWriter(string filename, int fourcc, double fps, Size frameSize, bool isColor)
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_11(filename, fourcc, fps, frameSize.width, frameSize.height, isColor);
        ...
        public VideoWriter(string filename, int fourcc, double fps, Size frameSize)
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_12(filename, fourcc, fps, frameSize.width, frameSize.height);
        ...
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, Size frameSize, bool isColor)
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_13(filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height, isColor);
        ...
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, Size frameSize)
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_14(filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height);
        ...
        public VideoWriter(string filename, int fourcc, double fps, Size frameSize, MatOfInt _params)
        {
            ...
            nativeObj = videoio_VideoWriter_VideoWriter_15(filename, fourcc, fps, frameSize.width, frameSize.height, _params_mat.nativeObj);
        ...
        public VideoWriter(string filename, int apiPreference, int fourcc, double fps, Size frameSize, MatOfInt _params)
        {
            if (_params != null) _params.ThrowIfDisposed();
            Mat _params_mat = _params;
            nativeObj = videoio_VideoWriter_VideoWriter_16(filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height, _params_mat.nativeObj);
