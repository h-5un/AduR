...
namespace OpenCVForUnity.ImgprocModule
{
    ...
    public class IntelligentScissorsMB : DisposableOpenCVObject
    {
        ...
        public IntelligentScissorsMB()
        {
            ...
            nativeObj = imgproc_IntelligentScissorsMB_IntelligentScissorsMB_10();
        ...
        public IntelligentScissorsMB setWeights(float weight_non_edge, float weight_gradient_direction, float weight_gradient_magnitude)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setWeights_10(nativeObj, weight_non_edge, weight_gradient_direction, weight_gradient_magnitude));
        ...
        public IntelligentScissorsMB setGradientMagnitudeMaxLimit(float gradient_magnitude_threshold_max)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setGradientMagnitudeMaxLimit_10(nativeObj, gradient_magnitude_threshold_max));
        ...
        public IntelligentScissorsMB setGradientMagnitudeMaxLimit()
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setGradientMagnitudeMaxLimit_11(nativeObj));
        ...
        public IntelligentScissorsMB setEdgeFeatureZeroCrossingParameters(float gradient_magnitude_min_value)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setEdgeFeatureZeroCrossingParameters_10(nativeObj, gradient_magnitude_min_value));
        ...
        public IntelligentScissorsMB setEdgeFeatureZeroCrossingParameters()
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setEdgeFeatureZeroCrossingParameters_11(nativeObj));
        ...
        public IntelligentScissorsMB setEdgeFeatureCannyParameters(double threshold1, double threshold2, int apertureSize, bool L2gradient)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setEdgeFeatureCannyParameters_10(nativeObj, threshold1, threshold2, apertureSize, L2gradient));
        ...
        public IntelligentScissorsMB setEdgeFeatureCannyParameters(double threshold1, double threshold2, int apertureSize)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setEdgeFeatureCannyParameters_11(nativeObj, threshold1, threshold2, apertureSize));
        ...
        public IntelligentScissorsMB setEdgeFeatureCannyParameters(double threshold1, double threshold2)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_setEdgeFeatureCannyParameters_12(nativeObj, threshold1, threshold2));
        ...
        public IntelligentScissorsMB applyImage(Mat image)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_applyImage_10(nativeObj, image.nativeObj));
        ...
        public IntelligentScissorsMB applyImageFeatures(Mat non_edge, Mat gradient_direction, Mat gradient_magnitude, Mat image)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_applyImageFeatures_10(nativeObj, non_edge.nativeObj, gradient_direction.nativeObj, gradient_magnitude.nativeObj, image.nativeObj));
        ...
        public IntelligentScissorsMB applyImageFeatures(Mat non_edge, Mat gradient_direction, Mat gradient_magnitude)
        {
            ...
            return new IntelligentScissorsMB(imgproc_IntelligentScissorsMB_applyImageFeatures_11(nativeObj, non_edge.nativeObj, gradient_direction.nativeObj, gradient_magnitude.nativeObj));
