...
namespace OpenCVForUnity.TrackingModule
{
    ...
    public class TrackerCSRT_Params : DisposableOpenCVObject
    {
        ...
        public TrackerCSRT_Params()
        {
            ...
            nativeObj = tracking_TrackerCSRT_1Params_TrackerCSRT_1Params_10();
        ...
        public string get_window_function()
        {
            ...
            string retVal = Marshal.PtrToStringAnsi(tracking_TrackerCSRT_1Params_get_1window_1function_10(nativeObj));
