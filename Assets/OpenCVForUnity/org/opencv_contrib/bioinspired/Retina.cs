...
namespace OpenCVForUnity.BioinspiredModule
{
    ...
    public class Retina : Algorithm
    {
        ...
        public Mat getMagnoRAW()
        {
            ...
            return new Mat(bioinspired_Retina_getMagnoRAW_11(nativeObj));
        ...
        public Mat getParvoRAW()
        {
            ...
            return new Mat(bioinspired_Retina_getParvoRAW_11(nativeObj));
        ...
        public static Retina create(Size inputSize)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_10(inputSize.width, inputSize.height));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrength)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_11(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor, samplingStrength));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_12(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_13(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_14(inputSize.width, inputSize.height, colorMode, colorSamplingMethod));
        ...
        public static Retina create(Size inputSize, bool colorMode)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_15(inputSize.width, inputSize.height, colorMode));
