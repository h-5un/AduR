...
namespace OpenCVForUnity.Xfeatures2dModule
{
    ...
    public class TBMR : AffineFeature2D
    {
        ...
        public static TBMR create(int min_area, float max_area_relative, float scale_factor, int n_scales)
        {
            ...
            return TBMR.__fromPtr__(xfeatures2d_TBMR_create_10(min_area, max_area_relative, scale_factor, n_scales));
        ...
        public static TBMR create(int min_area, float max_area_relative, float scale_factor)
        {
            ...
            return TBMR.__fromPtr__(xfeatures2d_TBMR_create_11(min_area, max_area_relative, scale_factor));
        ...
        public static TBMR create(int min_area, float max_area_relative)
        {
            ...
            return TBMR.__fromPtr__(xfeatures2d_TBMR_create_12(min_area, max_area_relative));
        ...
        public static TBMR create(int min_area)
        {
            ...
            return TBMR.__fromPtr__(xfeatures2d_TBMR_create_13(min_area));
        ...
        public static TBMR create()
        {
            ...
            return TBMR.__fromPtr__(xfeatures2d_TBMR_create_14());
